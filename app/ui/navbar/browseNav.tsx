...
export default function BrowseButton() {
  return (
    <Popover className="w-full hidden md:block z-50">
      {/* Popover Button */}
      <Popover.Button
        className="flex items-center h-[48px] p-3 hover:bg-gray-800 hover:text-white focus:bg-gray-800 focus:text-white border-none focus:outline-none focus:ring-0"
      >
      ...
      {/* Overlay */}
      <Popover.Overlay className="fixed inset-0 bg-black opacity-50 z-40" />

      {/* Popover Panel */}
      <Popover.Panel className="absolute bg-gray-800 text-gray-300 p-2 pb-5 mt-1 top-11 z-50">
        <div className="flex">
